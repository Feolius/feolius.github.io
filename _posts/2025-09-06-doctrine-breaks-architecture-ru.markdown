...
Это очень смелое утверждение, учитывая, что доменная модель может быть сложной, и в коде могут присутствовать
...
Основная проблема здесь в том, что разработчики действительно считали обработку одного запроса "единицей работы". Но на
практике это так только для очень простых сценариев. В жизни обработка запросов может быть сколь угодно сложной.
